...
KeyboardInputManager.prototype.targetIsInput = (event) =>
...
GameManager.prototype.PlaySound = (musicId) => {
...
GameManager.prototype.PlaySound2 = (musicId) => {
	const music = document.getElementById(musicId);
	console.log(music);
	console.log(music.paused);
	music.play();
...
GameManager.prototype.PlaySound3 = (musicId) => {
	const music = document.getElementById(musicId);
	console.log(music);
	console.log(music.paused);
	music.play();
